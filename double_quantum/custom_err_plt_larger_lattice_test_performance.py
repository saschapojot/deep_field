...
num_suffix=40000
num_epochs = 1200
inDirRoot="./custom_err_larger_lattice_test_performance/"

def N_2_test_file(N):
    in_model_dir = f"./custom_err_larger_lattice_test_performance/N{N}/C{C}/layer{layer_num}/"
...
def N_2_test_data_pkl(N):
    in_model_dir = inDirRoot+f"/N{N}/C{C}/layer{layer_num}/"
...
plt.savefig(inDirRoot+f"/custom_err_larger_lattice_test_performance_rate{rate}_layer{layer_num}.png")
