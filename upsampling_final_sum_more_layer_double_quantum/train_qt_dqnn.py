...
if (len(sys.argv)!=8):
    ...
    print("example: python train_qt_dqnn.py num_epochs decrease_over decrease_rate step_num_after_S1 N use_up upscale")
    exit(argErrCode)
...
N=int(sys.argv[5])
upBool=int(sys.argv[6])
if upBool==0:
    use_up=False
else:
    use_up=True
upscale=int(sys.argv[7])
...
out_model_dir=f"./out_model_data/N{N}/upscale{upscale}/layer{step_num_after_S1}/"
