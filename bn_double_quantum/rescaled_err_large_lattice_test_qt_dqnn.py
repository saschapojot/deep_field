...
#this function loads test data for larger lattices, with rescaled energy
...
model.load_state_dict(checkpoint['model_state_dict'])  # Load saved weightsmodel.to(device)  # Move model to device
...
outTxtFile=outResultDir+f"/custom_err_test_over{decrease_overStr}_rate{decrease_rateStr}_epoch{num_epochs}_num_samples{num_suffix}.txt"
